...
# ![Natural Language Processing (NLP)](data/animations/NLP-01.gif)
...
1. [NLP Foundations](01-NLP-Foundations) ![10%](https://geps.dev/progress/10)
2. [NLP Projects](02-NLP-Projects) ![10%](https://geps.dev/progress/10)
    1. [BERTicle: News Article Classifier using BERT](02-NLP-Projects/NLP_Project_01_BERTicle) ![10%](https://geps.dev/progress/10)
