...
10. [MLOps](MLOps) ![10%](https://geps.dev/progress/10)
    ...
    3. [MLOps Projects](MLOps/03-MLOps-Projects) ![10%](https://geps.dev/progress/10)
        1. [DanishGridInsight: End-to-End Production-Ready ML System for forecasting Hourly Energy Consumption Levels across Denmark using MLOps Best Practices](MLOps/03-MLOps-Projects/MLOps_Project_01_DanishGridInsight) ![10%](https://geps.dev/progress/10)
        2. [HeadlineHound: End-to-End Production Ready LLM-Powered News Headline Classifier](MLOps/03-MLOps-Projects/MLOps_Project_02_HeadlineHound) ![10%](https://geps.dev/progress/10)
