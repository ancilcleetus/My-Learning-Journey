...
6. Deep Learning                ![10%](https://progress-bar.dev/10)
    ...
    6. CV (Computer Vision)     ![10%](https://progress-bar.dev/10)
        1. CV Principles        ![10%](https://progress-bar.dev/10)
        2. CV Projects          ![10%](https://progress-bar.dev/10)
    7. NLP (Natural Language Processing)    ![10%](https://progress-bar.dev/10)
        1. NLP Principles       ![10%](https://progress-bar.dev/10)
        2. NLP Projects         ![10%](https://progress-bar.dev/10)
    8. Generative AI & LLMs (Large Language Models)     ![10%](https://progress-bar.dev/10)
