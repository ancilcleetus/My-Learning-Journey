# Emotion Classifier using Keras
...
> **`Note`**: Emotion Classifier Gradio App is not running right now. Demo video of Emotion Classifier Gradio App is given below. The App will be deployed in my personal website in the near future.
...
https://github.com/ancilcleetus/My-Learning-Journey/assets/25684256/f9104a3e-31ec-4650-8832-cff7c634dfd5

![rainbow](https://github.com/ancilcleetus/My-Learning-Journey/assets/25684256/839c3524-2a1d-4779-85a0-83c562e1e5e5)

## Future Improvements Envisioned:

1. Deployment in my personal website [Emotion Classifier App](http://ancilcleetus.com/Personal-Projects/Computer-Vision-Projects/CV_Project_01_Emotion_Classifier_Keras)
